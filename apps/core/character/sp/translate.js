...
const translates = {
	...
	jieyuan_more: "竭缘",
	jieyuan_less: "竭缘",
	jieyuan_info: "被动，1级：你造成伤害时，可选择一项：1.获得牌堆中的一张黑色牌；2.弃置一张黑色牌，此伤害+1。你受到伤害时，可选择一项：1.获得牌堆中的一张红色牌；2.弃置一张红色牌，此伤害-1。你在发动时可背水：删除另一个发动时机下的所有效果并升级此技能。<br>2级（背水造成伤害侧）：你造成伤害时，可选择一项：1.获得牌堆中的两张黑色牌；2.弃置一张黑色牌，此伤害+2。<br>3级（背水受伤侧）：你受到伤害时，可选择一项：1.获得牌堆中的两张红色牌；2.弃置一张红色牌，此伤害-2。",
	fenxin: "焚心",
	fenxin_info: "被动，被你杀死的角色亮出其身份牌前，你可选择一项：1.其亮出身份后，若与你阵营不同，获得其武将牌上的所有技能（限定技、觉醒技、使命技、主公技和持恒技除外）；2.与其交换身份牌（你与其身份牌均非明置时方可选择）。",
	qingyi: "轻逸",
	qingyi1: "轻逸",
	qingyi2: "轻逸",
	...
	yuhua: "羽化",
	yuhua_info: "锁定技。你的非基本牌不计入手牌上限；结束阶段，若你手牌数大于体力值，你观看牌堆顶X张牌（X为你手牌类别数），将其中任意数量的牌置于牌堆顶，其余的牌置于牌堆底。",
	qirang: "祈禳",
	qirang_info: "有装备牌置入你的装备区时，你可从牌堆中获得一张锦囊牌，你使用此锦囊牌时无距离限制并摸一张牌。",
	biluan: "避乱",
	...
	olshanjia: "缮甲",
	olshanjia_info: "出牌阶段限一次，你可摸三张牌，然后弃置X张牌（X为3-你本局失去过的装备区里的牌数）。若你未因此弃置：基本牌，你可视为使用一张不计入次数且无次数限制的普通【杀】；锦囊牌，你本阶段使用牌无距离限制。",
	ol_zhaozhong: "赵忠",
	olpengbi: "朋比",
