  ...
  arena() {
    ...
    if (lib.config.keep_awake) {
      if (window.plugins && window.plugins.insomnia) {
        ...
        __vitePreload(async () => {
          const { default: NoSleep } = await import("../../../_virtual/index2.js").then((n) => n.i);
    ...
    if (hasTouchInput) {
      ...
      if (!lib.config.touchscreen) {
        const moveRoundDrag = function(e) {
          ...
          var translate2 = ui.roundmenu._dragtransform.slice(0);
          ...
          ui.click.checkroundtranslate(translate2);
        ...
        const endRoundDrag = function(e) {
          ...
          if (ui.roundmenu._dragorigin && ui.roundmenu._dragtransform && ui.roundmenu._dragtouches) {
            ...
            if (dx * dx + dy * dy < 1e3) {
              ...
              translate2 = ui.roundmenu._dragtransform;
              ui.roundmenu.style.transform = "translate(" + translate2[0] + "px," + translate2[1] + "px)";
            } else {
              translate2 = ui.roundmenu._dragtransform;
              translate2[0] += dx;
              translate2[1] += dy;
          ...
          game.saveConfig("roundmenu_transform", translate2);
